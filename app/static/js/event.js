...
$(function () {
    function getEvent(event) {
        return  '<div class="event"><div class="event-hd clear"><p class="fl">'+event.title+'</p></div><div class="event-bd"><img src="'+event.poster_url+'" alt=""/><span class="question">'+event.description+'</span><p>费用：'+event.fee/100.0+'元</p><p>组织者：'+event.creator.name+'</p><p>开始时间：'+event.open_at+'</p><p>地点：'+'歌华大厦'+'</p></div><action><a onclick="join('+event.id+');">我要报名</></action></div>';
	}
